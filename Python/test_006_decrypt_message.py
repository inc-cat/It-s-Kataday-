...
def test_decrypt_uppercase():
    assert decrypt_message("XKYARZ JUKY TKKJ ZU HK OT AVVKXIGYK", -6) == "RESULT DOES NEED TO BE IN UPPERCASE"
    assert decrypt_message("SCRiX GfJk", 9) == "BLArG PoSt"

def test_abnormal_shifts():
    assert decrypt_message("mabl bl t oxkr vktsr mxlm...", -253) == "this is a very crazy test..."
